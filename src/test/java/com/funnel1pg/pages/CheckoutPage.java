...
public class CheckoutPage extends BasePage {
    ...
    // ?? Shipping Address Ñ exact IDs/names from live DOM ?????????????????????
    ...
    // ?? Payment Ñ exact IDs from live DOM ????????????????????????????????????
    ...
    public void selectShippingMethod() {
        System.out.println("? Vande Shipping pre-selected Ñ no action needed");
    }
    ...
    public void fillPaymentDetails(String cardType, String cardNumber,
        ...
        safeSelectByValue(SELECT_CARD_TYPE, cardType);   // e.g. "visa"
